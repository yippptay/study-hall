...
## Attendance
There are only two mandataory attendance checks during this project week, but as always please make sure you're working on your project every day! Especially since you'll be working in groups, make sure you communicate with each other every day!

  - **Wednesday, June 10**: You have Outcomes at 4:30 PM ET
  - **Monday, June 15**: Project presentation day! You're required to be in the class zoom starting at 10:00 AM ET

## Stand-ups
Not required, but a suggestion: consider having stand-ups with your group every day to keep track of how your project progress is coming along and to make sure you're communicating with each other daily. Consider the following points to talk about:
...
6. **To set up your shared database for deployment, [please follow these notes](/unit_3/w09d01/instructor_notes/Create%20React%20App%20%26%20Heroku.md). You will NEED to do this before starting anything else on your project.**
...
Your project is due on Monday, June 15 at 10:00 am ET. Your group will present your project and show your code to classmates and instructors.

:heavy_check_mark: Add your group project to [this google sheet](https://docs.google.com/spreadsheets/d/1ehispqNf_S4WeZnYdat7zkNO1VVoQOHG5zDMd6oZuLc/edit?usp=sharing).  Note that this is the order you will be presenting.
...
# Teams
1. Team Funkadelic Students: __James,	Will,	Ian__		__Coach: Arthur__
1. Team Codarific Students: __Taylor,	Bryce,	Jon__		__Coach: Arthur__
1. Team Boss Moves Students: __Dominic,	Curtis,	Caitlin,	Betty__	__Coach: Ayla the Awesome__
1. Team Half Code Half Amazing Students: __Abe,	Phil,	Ryan__		__Coach: Ayla the Awesome__
1. Team Reactivity Students: __Sali,	Emma,	Christian__		__Coach: Alex__
1. Team The Three Codestateers Students: __Michael,	Andy,	Sam__		__Coach: Alex__
1. Team Expressive Students: __Tom,	Cody,	Tyler__		__Coach: Jerrica__ 
1. Team Intrepid Coders Students: __Dana,	Sharon,	Sheila__		__Code: Jerrica__
