...
**Thursday, June 25th through Wednesday, July 8th**

- During these weeks, there is no required attendance outside of **Outcomes on Wednesdays at 4:30PM** and **Graduation Day**!
- Your instructor may check-in with you at least once
- There will be TA hours per usual with Yanny and Dan.
...
[More Information](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Nova/tree/master/projects/portfolio)
...
* Demonstrate that you can **teach yourself something new**, use a technology that you haven't used in class _NOR_ on a previous project
    <details><summary>Expand for a non-exhaustive list of examples:</summary>
        ...
        New Stack:
        - Ruby on Rails with Angular for the front end
