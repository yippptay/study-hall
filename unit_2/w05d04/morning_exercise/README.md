...
You've been given starter code for a pretty awful looking website in today's morning exercise folder called in `starter_code`.  Fix it up and make it C.R.A.P.!  
