...
In the `homework` directory for today, create an `express` directory and cd into it then create a Javascript file `server.js`. Write your answers inside this one js file.
...
#### Hints
 ...
 &#x1F534; **Commit** <br>
 <hr>
 "Pass it around application created."
 <hr>
