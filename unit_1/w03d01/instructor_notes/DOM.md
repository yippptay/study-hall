...
Refactor: Arthur Bernier Jr <br>
Topics: Intro to the DOM, Intro to 'Vanilla' JS<br>

## Lesson Objectives
- Define the DOM
- Explain what role the DOM plays in a web page and the CSSOM
...
![css-works-1](https://media.git.generalassemb.ly/user/15881/files/51052980-8877-11ea-847a-2205269befca)
